...
<head>
    ...
    <style>
        ...
        .global-skeleton input, .global-skeleton button, .global-skeleton img {
            background-color: #f3f4f6 !important;
            color: transparent !important;
            border-color: transparent !important;
            pointer-events: none !important;
...
<body class="global-skeleton min-h-screen flex flex-col md:flex-row bg-white">
    ...
    <div class="hero-section relative w-full md:w-1/2 h-64 md:h-screen bg-gray-50 flex items-center justify-center p-8 overflow-hidden">
        <img src="{{ asset('img/image-login2.png') }}" class="h-full md:w-3/4 object-contain transition-transform duration-700 hover:scale-105 slide-in-left">
    </div>
    ...
    <div class="form-section flex-1 flex items-start md:items-center justify-center p-6 md:p-16 lg:p-24 relative z-10 -mt-12 md:mt-0">
        <div class="bg-white w-full max-w-sm rounded-[2rem] md:rounded-none p-8 md:p-0 shadow-2xl shadow-gray-200/50 md:shadow-none border border-gray-100 md:border-none slide-in-right">
    ...
    <script>
        ...
        @if(Session::has('success'))
            showCustomToast('success', 'Berhasil Login', "{{ Session::get('success') }}");
        @endif
        @if(Session::has('error'))
            showCustomToast('error', 'Gagal', "{{ Session::get('error') }}");
        @endif
        @if($errors->any())
            showCustomToast('error', 'Gagal Login', "{{ $errors->first() }}");
        @endif
    </script>
</body>
</html>